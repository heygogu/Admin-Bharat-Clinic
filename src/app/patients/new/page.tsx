    ...
    <div className="flex flex-col gap-5">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Enter the new patient's details to create their record.</CardDescription>
        </CardHeader>
        <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Include any chronic conditions, allergies, or previous surgeries.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
